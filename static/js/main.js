...
function switchPage(page) {
  ...
  const _iframePages = ['tefas','kripto','bist','bofa','bist-endeks-getiri','bist-endeks-karisim','global','market-briefs','usa-endeks'];
  ...
  if (page === 'dth') {
    ...
    document.getElementById('page-bofa').classList.remove('hidden');
